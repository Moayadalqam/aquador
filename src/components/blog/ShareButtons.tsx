    ...
    <div className="flex items-center gap-3">
      ...
      {shareLinks.map((link) => (
        <a
          ...
          className="w-8 h-8 flex items-center justify-center rounded-full border border-gold/20 text-gray-400 hover:text-gold hover:border-gold/50 transition-all duration-300"
