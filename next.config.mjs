...
const nextConfig = {
  ...
  // - raw.githack.com / raw.githubusercontent.com: pmndrs/drei-assets HDR cube maps for the 3D
  //   perfume bottle Environment (read-only static texture fetches, no user data leaves the page)
